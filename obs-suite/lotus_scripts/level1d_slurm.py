...
PYSCRIPT = 'level1d_fix.py'
CONFIG_FILE = 'level1d.json'
...
for sid_dck in process_list:
    ...
    clean_ok += " --account=short4hr --wrap='python {0} {1} {2} {3}/$SLURM_ARRAY_TASK_ID.input 0 0'".format(py_clean_path,release,update,log_diri)
    ...
    clean_failed += " --account=short4hr --wrap='python {0} {1} {2} {3}/$SLURM_ARRAY_TASK_ID.input 1 1'".format(py_clean_path,release,update,log_diri)
