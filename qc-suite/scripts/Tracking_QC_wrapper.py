...
def write_submission(config, targetid, yr1, mn1, yr2, mn2, edge, runmonthid, outdir, runid):
    ...
    #codedir = '/gws/nopw/j04/c3s311a_lot2/code/marine_code/PRE_C3S/Met_Office_Marine_QC/'
    codedir = '/gws/smf/j04/c3s311a_lot2/dyb/release_4.0/glamod-marine-processing/qc-suite/scripts/'
    ...
    outfile.write("#SBATCH -p short-serial-4hr \n")
    outfile.write("#SBATCH --output {}/SPICE_trackqc_runout{}{:02}{}_{} \n".format(logdir, yr2, mn2, targetid.replace(" ", ""), runid))
    outfile.write("#SBATCH --error {}/SPICE_trackqc_errout{}{:02}{}_{} \n".format(logdir, yr2, mn2, targetid.replace(" ", ""), runid))
    outfile.write("#SBATCH -t 01:00:00 \n")
